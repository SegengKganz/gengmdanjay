...
let totalfi = Object.keys(global.plugins)
  ...
  conn.sendMessage(m.chat, {text: `*[ FRACTION LIST ]*\n\n ${tagList}\n\n*Total fitur:${totalfi} Commands*`,contextInfo: { externalAdReply: { title: wm, body: bottime, mediaType: 1, thumbnailUrl: 'https://telegra.ph/file/aecad5b582dc892756add.jpg', sourceUrl: 'https://Javanese', renderLargerThumbnail: true}}},{quoted:m,ephemeralExpiration: global.ephemeral})
}
